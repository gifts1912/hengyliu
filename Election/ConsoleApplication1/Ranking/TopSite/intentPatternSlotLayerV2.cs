...
namespace Ranking.TopSite.intentPatternSlotLayerV2
{
    public class intentPatternSlotLayerV2
    {
        ...
        public static void ReadIntentSlotPatternQuerylist(string QueryIntentSlotPatternFormatFile, Dictionary<string, Dictionary<string, Dictionary<string, int>>> intentSlotQueryFreq)
        {
            ...
            /* Dictionary<string, Dictionary<string, List<string>>> intentPatternSlotQuery 
             */
            int queryCol = 0, slotPatCol = 1, intentCol = 9;
           // int slotKeyCol = 4, slotValueCol = 5, queryCol = 0, slotCol = 2;
            StreamReader sr = new StreamReader(QueryIntentSlotPatternFormatFile);
            string line;
            while ((line = sr.ReadLine()) != null)
            {
        ...
        public static void RunFlag(string flag, bool domainUrlFlag)
        {
           ...
           // ReadPatternSlotFrequencyQuery(patternSlotQueryFile, PatternQueryFile, intentSlotPatternQueryFreq);
            ...
            string QueryIntentSlotPatternFormatFile = @"D:\Project\Election\QuerySet\queryFormatRankingInput.tsv";
            ReadIntentSlotPatternQuerylist(QueryIntentSlotPatternFormatFile, intentSlotPatternQueryFreq);
