    ...
    public class Program
    {
            ...
            using (StreamReader streamReader = new StreamReader(pat2topsite))
            {
                while (!streamReader.EndOfStream)
                {
                    ...
                    else
                    {
                        ...
                        Program.m_topSiteTable[keySort].Add(new TopSiteItem(strArray[2], strArray[3], strArray[4]));
                    }
                }
            }
        }
        ...
        public void main(string[] args)
        {
            ...
            else
            {
                ...
                {
                    using (StreamWriter streamWriter = new StreamWriter(args[2], true))
                    {
