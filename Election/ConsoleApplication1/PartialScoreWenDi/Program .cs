...
// MVID: A8A98FCF-D76B-4EB6-B63B-6F89B66C5766
// Assembly location: D:\watchModule\SBSPreferenceScore\SBSPreferenceScore.exe
  ...
  internal class Program
  {
   ...
   // private static Func<string, string> CS$<> 9__CachedAnonymousMethodDelegate1;;
    ...
    private static void Main(string[] args)
    {
      ...
      bool flag = true;
      Program.generator.Initialize(args1.TopN, args1.RankDiffWeightingString, args1.OutputWildcardPreferencePair == "true");
    ...
    private class Args : CmdOptions
    {
      ...
      [Argument(ArgumentType.AtMostOnce)]
      public string OutputWildcardPreferencePair;
      ...
      public Args()
      {
        ...
        this.OutputWildcardPreferencePair = "true";
        base.\u002Ector();
      }
    }
  }
